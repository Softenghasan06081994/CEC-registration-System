...
<body>
   ...
   <?php
    if (isset($_POST['submit'])) {
      ...
      $Mob_and_LNo          = $_POST['Mob_and_LNo'];
      $EmailAddress         = $_POST['EmailAddress'];
      $CNICPASSPORT         = $_POST['CNICPASSPORT'];
      $HomeAddress          = $_POST['HomeAddress'];


     $sql = "INSERT INTO personalinfo (nme,Dateofbirth, FathersName,MartialStatus,Mob_and_LNo,EmailAddress,CNICPASSPORT,HomeAddress) values(?,?,?,?,?,?,?,?)";
    $stmtinsert = $db->prepare($sql);
    $result = $stmtinsert->execute([$nme, $Dateofbirth,$FathersName, $MartialStatus, $Mob_and_LNo, $EmailAddress,$CNICPASSPORT,$HomeAddress]);
     if($result){
     ...
     <div class="container">
        ...
        <p> Fill up the form</p>
          <table style="width:35%">
           ...
           <th>Name</th>
           <td>
         <label for="nme"><b></b></label>
         
        
        <input class="form-control" type="text" name="nme" style="width: 220px; height:20px; " required=""><br><br>
        </td>
      </tr>
       <th>Date of Birth</th>
        <td>
       ...
       <th>Father's Name</th>
        ...
        <input class="form-control" type="text" name="Mob_and_LNo"style="width: 220px; height:20px;   "required=""><br><br>
        </td>
        </tr>
        <tr>
        <th>Email Address</th>
...
<script type="text/javascript">
  $(function(){
    $('#register').click(function(e){
      ...
      var MobileNumberLandLineNumber  = $('#Mob_and_LNo').val();
      var EmailAddress  = $('#EmailAddress').val();
      var CNICPASSPORT  = $('#').val();
      var HomeAddress  = $('#HomeAddress').val();
        ...
        $.ajax({
          type: 'POST',
          url: 'process.php',
          data: {nme: nme,Dateofbirth: Dateofbirth,FathersName: FathersName,MartialStatus:MartialStatus,Mob_and_LNo: Mob_and_LNo, EmailAddress: EmailAddress, CNICPASSPORT: CNICPASSPORT,HomeAddress: HomeAddress},
