...
$pinfoid = $_GET['pid'];
  ...
  $DivGradeGPA = $_POST["DivGradeGPA"][$key];
   $sql1 = "INSERT INTO qualification (pinfoid,DegreeDiploma,Institution,YearofPassing,DivGradeGPA) VALUES ('$pinfoid','$DegreeDiploma','$Institution','$YearofPassing','$DivGradeGPA')";
  mysqli_query($connection,$sql0);

  echo " Added Successfully ";
  echo $sql1 = "select * from qualification where Pinfoid = ".$row['id'];
$query0 = mysqli_query($connection,$sql1);
